...
function looksLikeLocationLine(line) {
  ...
  return /,|\b(?:ireland|pakistan|united kingdom|uk|usa|remote|limerick|cork|islamabad)\b/i.test(
    line
  );
}
...
const SECTION_HEADER_PATTERNS = {
  ...
  skills:
    /^(?:technical\s+skills|skills|technologies|tools|core\s+competencies|competencies|expertise)$/i,
...
function parseSectionsAdvanced(text) {
  ...
  result.summary = headerFields.summary;
